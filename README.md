...
<sub>Open-source AI agent hub template · Next.js + Supabase + OpenAI · RAG chatbot with auth, payments and admin dashboard · <a href="README.en.md">English version</a></sub>
...
The full README is available in English: **[README.en.md](README.en.md)**.
